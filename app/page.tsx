              ...
              <div className="grid gap-20 lg:grid-cols-2 lg:items-center">
                ...
                <div className="relative group perspective-1000">
                  ...
                  <div className="relative transform transition-transform duration-700 group-hover:rotate-1">
                    <VideoPlaceholder video={VIDEOS.find(v => v.id === "nft-dex")!} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="grid gap-20 lg:grid-cols-2 lg:items-center">
                <div className="order-2 lg:order-1 relative group perspective-1000">
                  ...
                  <div className="relative transform transition-transform duration-700 group-hover:-rotate-1">
                    <VideoPlaceholder video={VIDEOS.find(v => v.id === "aggregator")!} />
                  </div>
                </div>
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="grid gap-20 lg:grid-cols-2 lg:items-center">
                ...
                <div className="relative group perspective-1000">
                  ...
                  <div className="relative transform transition-transform duration-700 group-hover:rotate-1">
                    <VideoPlaceholder video={VIDEOS.find(v => v.id === "nft-bridge")!} />
                  </div>
                </div>
              </div>
            </div>
